    ...
    <section className={styles.body}>
      ...
      >
        ...
        <div className={styles.paras}>
          <Animate_p>
            Hey! I&apos;m Brahmbir singh, Software Developer living in Amritsar.
            I focus on connection and actually prefer working in group settings
            (shocker).
          </Animate_p>
          <Animate_p>
          ...
          <Animate_p>
            In addition to my coding pursuits, I indulge in game development as
            a hobby, exploring the realms of creativity and interactivity. My
          ...
          <Animate_p>
            Committed to writing clean code, providing exceptional user
            experiences, and staying updated with industry trends for innovative
            solutions.
          </Animate_p>
        </div>
      </motion.div>
