    ...
    <div className={styles.file_attachment_wrapper}>
      ...
      <label htmlFor={styles["file_input"]} className={styles.attach_button}>
        <svg
          fill="none"
          viewBox="0 0 56 56"
          className={styles.attach_paperclip}
        >
          <circle cx={28} cy={28} r="27.5" stroke="#C4C4C4" />
          <path
            d="M34.833 21.833v12.25a6.413 6.413 0 0 1-6.416 6.417A6.413 6.413 0 0 1 22 34.083V20.667A4.665 4.665 0 0 1 26.667 16a4.665 4.665 0 0 1 4.666 4.667v12.25a2.917 2.917 0 0 1-5.833 0V21.833h1.167v11.084a1.75 1.75 0 1 0 3.5 0v-12.25a3.5 3.5 0 0 0-7 0v13.416a5.25 5.25 0 1 0 10.5 0v-12.25h1.166Z"
            fill="#fff"
          ></path>
        </svg>
        ...
        <button
          onClick={(e) => {
            ...
            document
              .getElementById(styles["file_input"])
              .setAttribute("data-enter", "false");
            setFileName("");
          }}
          type="button"
        ...
        >
          <svg fill="none" viewBox="0 0 56 56">
            <path
              d="M55.35 28c0 15.105-12.245 27.35-27.35 27.35C12.895 55.35.65 43.105.65 28 .65 12.895 12.895.65 28 .65 43.105.65 55.35 12.895 55.35 28Z"
              stroke="#000"
              strokeWidth="1.3"
            />
            <path
              d="M18.81 18.808a1.3 1.3 0 0 1 1.839 0l16.546 16.546a1.3 1.3 0 1 1-1.838 1.839L18.81 20.646a1.3 1.3 0 0 1 0-1.838Z"
              fill="#32344D"
            />
            <path
              d="M37.195 18.808a1.3 1.3 0 0 0-1.838 0L18.81 35.354a1.3 1.3 0 0 0 1.839 1.839l16.546-16.547a1.3 1.3 0 0 0 0-1.838Z"
              fill="#32344D"
            />
          </svg>
        </button>
